	...
	<div class="pi-section pi-padding-bottom-80">
		...
		<div class="pi-row">
			...
			<div class="pi-col-xs-12">
				...
				<!-- Forms -->
				{{ Form::open(array('route' => 'pages.store', 'class' => 'panel-body wrapper-lg')) }}
					...
					<div class="form-group">
						...
						<div class="pi-input-with-icon">
							...
							{{ Form::text('page', '', array('class' => 'form-control', 'id' => 'page', 'placeholder' => 'Ingrese el titular')) }}
					...
					<div class="form-group">
						...
						<div class="pi-input-with-icon">
							<div class="pi-input-icon"><i class="icon-pencil"></i></div>
							<textarea class="form-control" id="html" name="html" placeholder="texto html" rows="30"></textarea>
					...
					<div class="form-group">
						<label for="exampleInputMessage-3">Activo</label>
							...
							{{ Form::select('activo', array('si' => 'Si', 'no' => 'No'), 'si', array('class' => 'form-control input-lg', 'id' =>'comentarios')) }}
					...
					<div class="form-group">
						<label for="exampleInputMessage-3">Mostrar Menu</label>
							...
							{{ Form::select('mostrar_menu', array('si' => 'Si', 'no' => 'No'), 'si', array('class' => 'form-control input-lg', 'id' =>'mostrar_menu')) }}
					...
					<!-- First name form -->
					<div class="form-group">
						<label for="titular">Url CEO</label>

						<div class="pi-input-with-icon">
							<div class="pi-input-icon"><i class="icon-pencil"></i></div>
							{{ Form::text('url_seo', '', array('class' => 'form-control', 'id' => 'url_seo', 'placeholder' => 'Ingrese URL CEO')) }}
